...
export function Sidebar() {
    return(
        ...
        <nav className='pt-6 mt-3 border-t border-zink-900 flex flex-col px-2'> 
            <a className="flex items-center gap-3 w-60 h-16 bg-danger hover:bg-white/10 ">
            ...
            <a className="flex items-center gap-3 w-60 h-16 hover:bg-white/10 ">
