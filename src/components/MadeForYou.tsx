...
export function MadeForYou(){
    return (
        ...
        <a href='' className='group bg-white/5 p-3 rounded-md hover:bg-white/10 flex flex-col gap-2'>
          <Image className='w-full rounded-md' width={140} height={140} src="/this-is-djavan.jpeg"  alt="capa da playlist"  />
        ...
        <a href='' className='bg-white/5 p-3 rounded-md hover:bg-white/10 flex flex-col gap-2'>
          <Image className='w-full rounded-md' width={140} height={140} src="/mix-verao2024.jpeg"  alt="capa da playlist" />
          <strong className='font-semibold'>Verão 2024</strong>
          <span className='text-sm text-zinc-400 '>...MORO NUM PAÍS <br /> TROPICAL</span>
        </a>
        <a href='' className='bg-white/5 p-3 rounded-md hover:bg-white/10 flex flex-col gap-2'>
          <Image className='w-full rounded-md' width={140} height={140} src="/mix-jazz-classics.jpeg"  alt="capa da playlist"  />
        ...
        <a href='' className='bg-white/5 p-3 rounded-md hover:bg-white/10 flex flex-col gap-2'>
          <Image className='w-full rounded-md' width={140} height={140} src="/novidades.jpeg"  alt="capa da playlist"  />
        ...
        <a href='' className='bg-white/5 p-3 rounded-md hover:bg-white/10 flex flex-col gap-2'>
          <Image className='w-full rounded-md' width={140} height={140} src="/mix-ano2000.jpeg"  alt="capa da playlist"  />
        ...
        <a href='' className='bg-white/5 p-3 rounded-md hover:bg-white/10 flex flex-col gap-2'>
          <Image className='w-full rounded-md' width={140} height={140} src="/daily-mix5.jpeg"  alt="capa da playlist"  />
